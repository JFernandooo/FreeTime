...
| Versão | Destaques |
|--------|-----------|
| v2.1.8 | Corrigida a causa real de "não foi possível agendar a notificação" em builds de release (regras de R8 em falta); a mensagem também deixa de apontar sempre para a permissão de alarme exato quando não era essa a causa |
